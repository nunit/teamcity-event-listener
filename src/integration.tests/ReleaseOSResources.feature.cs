...
#line hidden
        ...
        public virtual void AgentIsFinishedWhenAppDomainAreNotUnloadedCorrectly(string frameworkVersion, string platform, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Agent is finished when AppDomain are not unloaded correctly", null, @__tags);
#line 8
