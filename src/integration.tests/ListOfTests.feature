...
Scenario Outline: I can explore tests and write the list of tests to file
    ...
    And I added the arg Explore=mocks\AllTests.xml to NUnit console command line
...
Scenario Outline: I can explore tests and write the list of tests to file for several assemblies
    Given Framework version is <frameworkVersion>	
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests1 for foo1.tests
    And I added successful method as SuccessfulTest2 to the class Foo.Tests.UnitTests1 for foo1.tests
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests2 for foo1.tests
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests1 for foo2.tests
    And I created the folder mocks
...
Scenario Outline: I can run tests from the list of tests
    Given Framework version is <frameworkVersion>	
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests1 for foo.tests
    And I added successful method as SuccessfulTest2 to the class Foo.Tests.UnitTests2 for foo.tests
    And I added successful method as SuccessfulTest3 to the class Foo.Tests.UnitTests3 for foo.tests
    And I created the folder mocks
    And I added NUnit framework references to foo.tests
    And I copied NUnit framework references to folder mocks
    And I compiled the assembly foo.tests to file mocks\foo.tests.dll	
    And I added the assembly mocks\foo.tests.dll to the list of testing assemblies
    And I appended the line Foo.Tests.UnitTests1 to file mocks\ListOfTests.txt
    And I appended the line Foo.Tests.UnitTests2 to file mocks\ListOfTests.txt
    And I added the arg TestList=mocks\ListOfTests.txt to NUnit console command line
    When I run NUnit console
    Then the exit code should be 0
...
Scenario Outline: I can run tests from the list of tests for several assemblies
    Given Framework version is <frameworkVersion>	
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests1 for foo1.tests
    And I added successful method as SuccessfulTest2 to the class Foo.Tests.UnitTests2 for foo1.tests
    And I added successful method as SuccessfulTest3 to the class Foo.Tests.UnitTests3 for foo1.tests
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests4 for foo2.tests
    And I added successful method as SuccessfulTest1 to the class Foo.Tests.UnitTests1 for foo2.tests
    And I created the folder mocks
    And I added NUnit framework references to foo1.tests
    And I added NUnit framework references to foo2.tests
...
Scenario Outline: I can run tests from the list of tests for several assemblies from different directories
    ...
    And I added NUnit framework references to foo1.tests
    And I added NUnit framework references to foo2.tests
    And I created the folder mocks\1
    And I copied NUnit framework references to folder mocks\1	
    And I compiled the assembly foo1.tests to file mocks\1\foo1.tests.dll	
    And I created the folder mocks\2
    And I copied NUnit framework references to folder mocks\2
    And I compiled the assembly foo2.tests to file mocks\2\foo2.tests.dll
    And I added the assembly mocks\1\foo1.tests.dll to the list of testing assemblies
    And I added the assembly mocks\2\foo2.tests.dll to the list of testing assemblies
    And I appended the line Foo.Tests.UnitTests1 to file mocks\ListOfTests.txt
    And I appended the line Foo.Tests.UnitTests2 to file mocks\ListOfTests.txt
    And I added the arg TestList=mocks\ListOfTests.txt to NUnit console command line
    And I want to use <configurationType> configuration type
